...
public class MadLib2 {
  ...
  */
	...
	public static void main(String[] args){
		...
		//enter a number 
		//note the use of .nextInt() instead of .nextLine()
	  	System.out.println("Please enter a number:");
			...
			+noun4+"s very "+adjective3+". Concerned, "+name1+" texted "+name2+", who flew "+name1+" to "+
			place1+" and dropped "+name1+" in a puddle of frozen "+noun5+". "+name1+" woke up in the year "+
